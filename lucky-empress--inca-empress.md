...
safePreviewBlurb: "Lucky Empress and its sister game, Inca Empress, feature persistent multipliers that stick to the left side of the rows. The multipliers first..."
volatility: high
denomination: multi
minBet: "$0.88"
maxBet: "Varies"
lookFor: "Active 10x or 12x multiplier (shows 'X NEXT PAY' on row) | Active multipliers totaling 10x+ (e.g., two 5x or 8x+3x) | 5x or 8x active with 10x/12x queued behind it"
stopPlaying: "After multiplier triggers on a line hit and no 10x+ total remains active or queued"
heroImage: "/images/games/lucky-empress--inca-empress-1.jpg"
images: [
    {
      "src": "/images/games/lucky-empress--inca-empress-1.jpg",
      "alt": "LUCKY EMPRESS / INCA EMPRESS",
      "caption": ""
    },
    {
      "src": "/images/games/lucky-empress--inca-empress-3.jpg",
      "alt": "LUCKY EMPRESS / INCA EMPRESS",
      "caption": "The free games feature can pay big even on small bets, but it can often disappoint as well."
    },
    {
      "src": "/images/games/lucky-empress--inca-empress-4.jpg",
      "alt": "LUCKY EMPRESS / INCA EMPRESS",
      "caption": "Never play in situations like this where the multipliers are not yet revealed."
    }
  ]
---
