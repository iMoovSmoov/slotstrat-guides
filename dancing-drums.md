...
safePreviewBlurb: "Dancing Drums features a multi-state progressive system with fu bat symbols that can appear above the reels. Each fu bat symbol that lands activates its corresponding reel position, and activated positions persist across spins until the feature triggers."
volatility: high
denomination: multi
minBet: "$0.88"
maxBet: "Varies"
lookFor: "3+ fu bat symbols active above the reels"
stopPlaying: "After bonus feature triggers and completes (fu bats reset)"
heroImage: "/images/games/dancing-drums-1.jpg"
images: [
    {
      "src": "/images/games/dancing-drums-1.jpg",
      "alt": "Dancing Drums",
      "caption": ""
    }
  ]
