...
safePreviewBlurb: "Wheel of Fortune 4D Collector’s Edition features a credit prize above each reel that increases in value whenever coin symbols land in that reel...."
volatility: medium
denomination: multi
minBet: "$0.88"
maxBet: "Varies"
lookFor: "Total prizes above all 5 reels = 70x+ bet (prefer values spread across reels 2 and 4) | Advanced: Weighted total = 45x+ bet (R1×0.7, R2×0.9, R3×0.5, R4×1.0, R5×0.33)"
stopPlaying: "After Collect symbol triggers and prizes are awarded"
heroImage: "/images/games/wheel-of-fortune-4d-collectors-edition-1.jpg"
images: [
    {
      "src": "/images/games/wheel-of-fortune-4d-collectors-edition-1.jpg",
      "alt": "Wheel of Fortune 4D Collector's Edition",
      "caption": ""
    },
    {
      "src": "/images/games/wheel-of-fortune-4d-collectors-edition-2.jpg",
      "alt": "Wheel of Fortune 4D Collector's Edition",
      "caption": "This is a solid play with the total prizes equal to 70x the bet level (or 50x when you use the weighted values method)."
    }
  ]
---
