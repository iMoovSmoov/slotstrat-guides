...
safePreviewBlurb: "Egyptian Stars features blue star-shaped frames that move up one position every spin. If one of the frames lands on top of a credit value, the..."
volatility: high
denomination: multi
minBet: "$0.88"
maxBet: "Varies"
lookFor: "2+ blue star frames anywhere except top row (top row frames leave next spin)"
stopPlaying: "All star frames have moved off the top row (watch for frame bursts from woman's hand star)"
heroImage: "/images/games/egyptian-stars-1.jpg"
images: [
    {
      "src": "/images/games/egyptian-stars-1.jpg",
      "alt": "EGYPTIAN STARS",
      "caption": ""
    },
    {
      "src": "/images/games/egyptian-stars-2.jpg",
      "alt": "EGYPTIAN STARS",
      "caption": "The blue star-shaped frames move up one position every spin. The frame in the upper left will move off screen next spin, so only play if there are frames below the top row."
    },
    {
      "src": "/images/games/egyptian-stars-3.jpg",
      "alt": "EGYPTIAN STARS",
      "caption": "Landing a blue star-shaped frame on top of a jackpot symbol will award that prize. The $10 mini is a solid win on a $0.75 bet."
    }
  ]
---
